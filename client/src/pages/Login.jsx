...
const Login = () => {
  ...
  return (
    ...
    <div>
          ...
          <form className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white" onSubmit={handleLogin}>
            ...
            <div className="flex items-center mt-4 w-full bg-white border border-gray-300/80 h-12 rounded-full overflow-hidden relative pl-6 gap-2">
              ...
              />
              <span className=' text-indigo-500 cursor-pointer absolute right-[20px]' onClick={()=>setShow(prev=>!prev)}>{show? "hide  ":"show"}</span>
            ...
            <p className="text-gray-500 text-sm mt-3 mb-11">
              ...
              <Link  to="/signUp">
                <h1 className=' text-indigo-500 hover:opacity-90'>click here</h1>
              </Link>
